...
APP_ICON = Path(__file__).resolve().parents[4] / "starco_icon.ico"
...
class WelcomeWindow(tk.Tk, BaseWindow):
    ...
    def __new__(cls, *args, **kwargs):
        from app.ui.windows.clients_progress_ui import WelcomeWindow as CanonicalWelcomeWindow
...
class ProgressApp(tk.Tk):
    ...
    def __new__(cls, *args, **kwargs):
        from app.ui.windows.clients_progress_ui import ProgressApp as CanonicalProgressApp
...
def build_startup_splash():
    from app.ui.windows.clients_progress_ui import build_startup_splash as canonical_build_startup_splash
    return canonical_build_startup_splash()


def open_overview_window():
    from app.ui.windows.clients_progress_ui import open_overview_window as canonical_open_overview_window
    return canonical_open_overview_window()


def open_welcome_home():
    from app.ui.windows.clients_progress_ui import open_welcome_home as canonical_open_welcome_home
    return canonical_open_welcome_home()


def safe_main():
    from app.ui.windows.clients_progress_ui import safe_main as canonical_safe_main
